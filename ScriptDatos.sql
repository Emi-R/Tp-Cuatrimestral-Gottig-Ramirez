...
insert into Usuarios (Contraseña, DNI, Nombre, Apellidos, Telefono, Email, Calle, Numero, Piso, Departamento, IDNacionalidad, TipoPerfil, FechaNac, FechaRegistro, Estado) values ('zjfv', 17100895, 'Andréa', 'Kringe', '2778920958', 'nkringe3@wikia.com', 'Michigan', '841', null, null, 8, 2, '1996-05-13', '2020-11-05', 2);
...
Insert Into TipoPlatos(Nombre)
values
('Principal'),
('Postre')

Insert Into Insumos (Nombre, Precio, IdTipoPlato, IdTipoInsumo)
Values 
('Ensalada Cesar', 500, 1, 2),
('Ensalada Lechuga y Tomate', 300, 1, 2),
